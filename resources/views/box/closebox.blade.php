                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Cierre de caja {{$iduserbox}} para el día {{$date_close_box}} </h3>
                            </div>


                            <form id="frmProsecutor" name="frmProsecutor" method="post" action="{{route('box.store')}}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="total_amount">Total en Caja</label>
                                        <input type="text" class="form-control" id="total_amount" name="total_amount" value="{{$total_receipt}}" readonly>
                                   </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-info"><i class="fas fa-solid fa-user-plus"></i> Chequeado</button>
                                </div>
                            </form>
                        </div>
                    @stop
