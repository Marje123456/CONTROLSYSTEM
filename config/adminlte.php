        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'submenu' => [
                        [
                            ...
                            'icon_color' => 'red',
                            'can' => 'configuracion-usuarios-gestionar_usuarios',
                        ],
                        [
                            ...
                            'icon_color' => 'red',
                            'can' => 'configuracion-usuarios-gestionar_roles',
                        ],
                        [
                            ...
                            'icon_color' => 'red',
                            'can' => 'configuracion-usuarios-gestionar_permisos',
                        ],
                    ],
                ],
                [
                    ...
                    'can' => 'configuracion-cambio_estatus_maquina',
                    'icon_color' => 'red',
                ],
                [
                    ...
                    'can' => 'configuracion-impuesto_por_maquina',
                    'icon_color' => 'red',
                ],
                [
                    ...
                    'can' => 'configuracion-porcentaje_pago_a_empresa',
                    'icon_color' => 'red',
                ],
                ...
                [
                    'text' => 'Auditoria',
                    'icon' => 'fas fa-fw fa-solid fa-user-shield',
                    'can' => 'configuracion-auditoria',
                    'submenu' => [
                        [
                            'text' => 'Fiscalizar Local',
                            'route'  => 'premise.auditprub',
                            'icon' => 'fas fa-fw fa-solid fa-user-shield',
                            'can' => 'configuracion-auditoria-fiscalizar_local',
                        ],
                        /* [
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'icon_color' => 'yellow',
                    'icon' => 'fas fa-fw fa-solid fa-user-nurse',
                    'can' => 'gestion_fiscales-fiscal_index',
                ],
                [
                    'text' => 'Crear Ruta',
                    ...
                    'icon_color' => 'yellow',
                    'can' => 'gestion_fiscales-crear_ruta',
                ],
                [
                    'text' => 'Ver Rutas',
                    ...
                    'icon_color' => 'yellow',
                    'can' => 'gestion_fiscales-ver_rutas',
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'icon_color' => 'green',
                    'can' => 'registrar_rlm-representante_index',
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'icon_color' => 'blue',
                    'can' => 'cierres-cierre_municipalidad',
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'icon' => 'fas fa-fw fa-solid fa-coins',
                    'icon_color' => 'orange',
                    'can' => 'reportes-mis_pagos_responsible',
                ],
                [
                    'text' => 'Mi Recorrido',
                    ...
                    'icon' => 'fas fa-fw fa-route',
                    'icon_color' => 'orange',
                    'can' => 'reportes-mi_recorrido_fiscal',
                ],
                [
                    'text' => 'Representantes',
                    ...
                    'icon' => 'fas fa-fw fa-solid fa-user-tie',
                    'icon_color' => 'orange',
                    'can' => 'reportes-reporte_rlm-representantes',
                ],
                [
                    'text' => 'Local',
                    'route'  => 'premise.index',
                    ...
                    'icon_color' => 'orange',
                    'can' => 'reportes-reporte_rlm-local',
                ],
                [
                    'text' => 'Máquina',
                    'route'  => 'machine.index',
                    ...
                    'icon_color' => 'orange',
                    'can' => 'reportes-reporte_rlm-maquina',
                ],
                [
                    ...
                    'icon_color' => 'orange',
                    'can' => 'reportes-maquina_orden_imp',
                ],
                [
                    ...
                    'icon_color' => 'orange',
                    'can' => 'reportes-auditorias_locales',
                ],
